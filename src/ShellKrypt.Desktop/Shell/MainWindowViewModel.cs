...
using AppState = ShellKrypt.Desktop.Shell.Runtime.AppState;
using ClipboardService = ShellKrypt.Desktop.Shell.Runtime.ClipboardService;
using SessionSecurityService = ShellKrypt.Desktop.Shell.Runtime.SessionSecurityService;
