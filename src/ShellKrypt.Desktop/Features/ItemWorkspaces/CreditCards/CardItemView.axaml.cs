...
{
    public static readonly StyledProperty<ICommand?> ShowDetailsCommandProperty = AvaloniaProperty.Register<CardItemView, ICommand?>(nameof(ShowDetailsCommand));
    public static readonly StyledProperty<ICommand?> ToggleSecretCommandProperty = AvaloniaProperty.Register<CardItemView, ICommand?>(nameof(ToggleSecretCommand));
    public static readonly StyledProperty<ICommand?> CopySecretCommandProperty = AvaloniaProperty.Register<CardItemView, ICommand?>(nameof(CopySecretCommand));

    public CardItemView() => InitializeComponent();
