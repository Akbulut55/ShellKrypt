...
internal static class VaultItemDuplicateKey
{
    ...
    internal static void ValidatePayload(ItemType type, string payloadJson)
        => _ = BuildDuplicateKey(type, payloadJson);

    internal static HashSet<string> BuildSet(VaultSnapshot snapshot)
    {
    ...
    internal static Dictionary<string, string> BuildMap(VaultSnapshot snapshot)
    {
