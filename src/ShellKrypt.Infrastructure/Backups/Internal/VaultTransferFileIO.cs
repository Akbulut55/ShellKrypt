...
internal static class VaultTransferFileIO
{
    internal static async Task WriteTextAsync(string path, string content, CancellationToken ct)
    {
    ...
    internal static void EnsureFileSize(string path, long maxBytes, string label)
    {
    ...
    internal static byte[] DecodeBase64Field(string value, string label)
    {
        try
        {
