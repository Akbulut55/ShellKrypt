...
public interface IItemRepository
{
    ...
    Task<IReadOnlyList<VaultLabelRow>> ListLabelsAsync(string vaultPath, CancellationToken ct = default);
    Task<VaultLabelRow> UpsertLabelAsync(string vaultPath, string name, string? color = null, CancellationToken ct = default);
