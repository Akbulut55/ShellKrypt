...
| SourceGear.sqlite3 / SQLite | 3.50.4.5 | SQLite authors | Native SQLite library | SQLite public domain dedication | No license attribution is required by SQLite; retain the public-domain statement for clarity. |
